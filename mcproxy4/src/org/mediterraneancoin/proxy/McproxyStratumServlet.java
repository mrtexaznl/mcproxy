...
import static org.mediterraneancoin.proxy.McproxyServlet.DEBUG;
import static org.mediterraneancoin.proxy.McproxyServlet.utils;
import static org.mediterraneancoin.proxy.McproxyServlet.works;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (type.toString().equals("application/json") && jsonMethod.equals("getwork") && paramSize == 0) {
            ...
            if (false) {
                ...
                McproxyHandler.SessionStorage sessionStorage = new McproxyHandler.SessionStorage();
            ...
            //SuperHasher hasher 
            McproxyHandler.SessionStorage sessionStorage = works.get(receivedDataStr.substring(0, 68*2));
